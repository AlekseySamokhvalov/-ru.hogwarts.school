...
class FacultyControllerTest {
    ...
    private static final Object MOCK_FACULTY_NAME = "Факультет1";
    private static final Object MOCK_FACULTY_COLOR = "белый";
    private static final long  MOCK_FACULTY_ID = 2;
    private static final String MOCK_FACULTY_NEW_NAME = "черный";
    @Autowired
    ...
    public void getFacultyByNameOrByColor() throws Exception {
        when(facultyRepository.findByColorContainsIgnoreCaseOrNameContainsIgnoreCase (anyString(), anyString())).thenReturn(MOCK_FACULTY);
